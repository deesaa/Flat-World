...
public class BattleSystemAct implements Action{
	...
	BattleSystemAct(BasicObjectClass Object, TexturesClass PerHealScaleTex, Vector3f PerHealScaleContourColor, int maxHealpoints, int healpoints){
	...
	BattleSystemAct(BasicObjectClass Object, PlayerGUIAct PlayerGUI, int maxHealpoints, int healpoints){
		Object.Modifiers.pointerToBattleSystem = this;
